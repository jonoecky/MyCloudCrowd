...
$getAboutMe 	= 			$getUserData['aboutMe'];
$getEducation 	=	 		$getUserData['education'];
$getTraining 	= 			$getUserData['training'];
$getExperience 	= 			$getUserData['experience'];
$getWorkHistory = 			$getUserData['workHistory'];
$getKeySkills 	= 			$getUserData['keySkills'];
$getAdditionalInformation = $getUserData['aditionalInformation'];